...
import "../contracts/FrontRunnable.sol";

/**
 * @title FrontRunnable Fuzzing Properties
 * @notice Auto-generated property tests for Medusa/Echidna
 * @dev Generated by tools/generate_properties.py
 */
contract FrontRunnableProperties {
    FrontRunnable public target;
    
    // Track initial state
    uint256 private initialTotalSupply;
    
    constructor() {
        target = new FrontRunnable();
