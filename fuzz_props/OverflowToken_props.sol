...
import "../contracts/OverflowToken.sol";

/**
 * @title OverflowToken Fuzzing Properties
 * @notice Auto-generated property tests for Medusa/Echidna
 * @dev Generated by tools/generate_properties.py
 */
contract OverflowTokenProperties {
    OverflowToken public target;
    
    // Track initial state
    uint256 private initialTotalSupply;
    
    constructor() {
        target = new OverflowToken();
